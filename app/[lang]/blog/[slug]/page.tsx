...
async function fetchBlog(slug: string, lang?: string): Promise<Blog | null> {
  const url = lang ? `${API}/api/blogs/${slug}?lang=${lang}` : `${API}/api/blogs/${slug}`;
      ...
      <div className="bg-surface2-color">
        <div className="tf-container">
          <ul className="breadcrumb text-caption-1 text_on-surface-color">
            <li><Link href={`/${lang}`} className="link">Home</Link></li>
            <li>
              <Link href={`/${lang}/categories-1`} className="link">
