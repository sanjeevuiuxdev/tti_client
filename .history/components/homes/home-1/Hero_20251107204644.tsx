...
function toCard2(b: Blog) {
  return {
    id: b.slug,    
    slug: b.slug,                       // Blogcard2 links use post.id
  ...
  return (
    <div className="page-title homepage-1 sw-layout">
      <div className="tf-container">
        ...
        {/* Banner slider — leave as-is, wire later */}
        <Swiper
        ...
        >
          {/* TODO: replace static banners later */}
          <SwiperSlide className="swiper-slide" key="placeholder">
            <div className="hero-banner style-default">
              <div className="img-thumbs">
                <Image width={1800} height={700} alt="page-title"
                  src="/placeholder-1800x700.jpg" priority />
                <Link href="#" className="overlay-link" />
              </div>
              <div className="content cs-entry__content" data-swiper-parallax="-400" data-swiper-parallax-duration="800">
                <div className="content__top d-flex justify-content-between">
                  <span className="tag categories text-title text_white">Banner</span>
                  <div className="tag time text-title text_white"><i className="icon-Timer" /> — </div>
                </div>
                <div className="content__body">
                  <h1 className="text_white mb_24">Your banner goes here</h1>
                  <p className="text_white line-clamp-2">Replace with dynamic banner later.</p>
                </div>
              </div>
            </div>
          </SwiperSlide>
