...
// Adapt backend Blog → BlogCard1 props
...
export default async function HighlightPosts() {
  ...
  const colA: ReturnType<typeof toCard>[] = [];
  const colB: ReturnType<typeof toCard>[] = [];
  const colC: ReturnType<typeof toCard>[] = [];

  items.forEach((p: ReturnType<typeof toCard>, i: number) => {
