      ...
      <div className="page-title style-default">
        <div className="tf-container">
          ...
          <p>
            ...
            from mindful living and travel <br /> adventures to style, wellness,
            and beyond.
          </p>
        </div>
      </div>
            ...
            <div className="row">
              <div className="col-lg-9">
                ...
                <div>
                  {visible.length ? (
                    visible.map((post) => (
                      <BlogCard4 post={post} key={post._id} />
                    ))
                  ) : (
              ...
              {/* Sidebar placeholder — you’ll replace with your sidebar code */}
              <div className="col-lg-3">
                <div className="widget">
                  <h5 className="mb_16">Sidebar Placeholder</h5>
                  <p>Will replace this when you send sidebar code.</p>
                </div>
              </div>
            </div>
          </div>
